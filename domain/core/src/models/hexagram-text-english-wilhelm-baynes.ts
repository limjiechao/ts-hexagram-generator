...
export const HEXAGRAM_TEXT_ENGLISH_WILHELM_BAYNES = {
  1: {
    Scripture: {
      Hexagram:
        'THE CREATIVE works sublime success,\nFurthering through perseverance.',
      Lines: {
        L1: 'Nine at the beginning means:\nHidden dragon. Do not act.',
        L2: 'Nine in the second place means:\nDragon appearing in the field.\nIt furthers one to see the great man.',
        L3: 'Nine in the third place means:\nAll day long the superior man is creatively active.\nAt nightfall his mind is still beset with cares.\nDanger. No blame.',
        L4: 'Nine in the fourth place means:\nWavering flight over the depths.\nNo blame.',
        L5: 'Nine in the fifth place means:\nFlying dragon in the heavens.\nIt furthers one to see the great man.',
        L6: 'Nine at the top means:\n\nArrogant dragon will have cause to repent.',
      },
    },
    Exegesis: {
      Judgment:
      ...
      Miscellaneous: 'THE CREATIVE is strong.',
      Sequence: null,
      Extracts: null,
    },
  },
  2: {
    Scripture: {
      ...
      Lines: {
        L1: 'Six at the beginning means:\nWhen there is hoarfrost underfoot,\nSolid ice is not far off.',
        L2: 'Six in the second place means:\nStraight, square, great.\nWithout purpose,\nYet nothing remains unfurthered.',
        L3: 'Six in the third place means:\nHidden lines.\nOne is able to remain persevering.\nIf by chance you are in the service of a king,\nSeek not works, but bring to completion.',
        L4: 'Six in the fourth place means:\nA tied-up sack. No blame, no praise.',
        L5: 'Six in the fifth place means:\nA yellow lower garment brings supreme good fortune.',
        L6: 'Six at the top means:\nDragons fight in the meadow.\nTheir blood is black and yellow.',
      },
    },
    Exegesis: {
      Judgment:
  ...
  3: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'Chun is visible but has not yet lost its dwelling.',
      Sequence:
  ...
  5: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'WAITING means not advancing.',
      Sequence:
  ...
  6: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'CONFLICT means not to love.',
      Sequence:
  ...
  7: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE ARMY means mourning.',
      Sequence:
  ...
  8: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'HOLDING TOGETHER is something joyous.',
      Sequence:
  ...
  9: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE TAMING POWER OF THE SMALL is slight.',
      Sequence:
  ...
  10: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'That which treads does not stay.',
      Sequence:
  ...
  13: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'Fellowship with men finds love.',
      Sequence:
  ...
  14: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'POSSESSION IN GREAT MEASURE indicates the mass.',
      Sequence:
  ...
  15: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'Things are easy for the modest person.',
      Sequence:
  ...
  16: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'ENTHUSIASM leads to inertia.',
      Sequence:
  ...
  17: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'FOLLOWING tolerates no old prejudices.',
      Sequence:
  ...
  18: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'WORK ON WHAT HAS BEEN SPOILED. Afterward there is order.',
      Sequence:
  ...
  21: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'BITING THROUGH means consuming.',
      Sequence:
  ...
  22: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'GRACE means being undyed.',
      Sequence:
  ...
  23: {
    Scripture: {
      Hexagram: 'SPLITTING APART. It does not further one\nTo go anywhere.',
      Lines: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'SPLITTING APART means decay.',
      Sequence:
  ...
  24: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'RETURN means coming back.',
      Sequence:
  ...
  25: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE UNEXPECTED means misfortune from without.',
      Sequence:
  ...
  26: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE TAMING POWER OF THE GREAT depends on the time.',
      Sequence:
  ...
  28: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'PREPONDERANCE OF THE GREAT is the peak.',
      Sequence:
  ...
  29: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE ABYSMAL is directed downward.',
      Sequence:
  ...
  30: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE CLINGING is directed upward.',
      Sequence:
  ...
  31: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'INFLUENCE fulfills itself quickly.',
      Sequence:
  ...
  32: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'DURATION means that which lasts long.',
      Sequence:
  ...
  33: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'RETREAT means withdrawing.',
      Sequence:
  ...
  34: {
    Scripture: {
      Hexagram: 'THE POWER OF THE GREAT. Perseverance furthers.',
      Lines: {
  ...
  35: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'PROGRESS means the day.',
      Sequence:
  ...
  36: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'DARKENING OF THE LIGHT means injury.',
      Sequence:
  ...
  37: {
    Scripture: {
      Hexagram: 'THE FAMILY. The perseverance of the woman furthers.',
      Lines: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE FAMILY is inside.',
      Sequence:
  ...
  38: {
    Scripture: {
      Hexagram: 'OPPOSITION. In small matters, good fortune.',
      Lines: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'OPPOSITION means estrangement.',
      Sequence:
  ...
  39: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'OBSTRUCTION means difficulty.',
      Sequence:
  ...
  40: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'DELIVERANCE means release from tension.',
      Sequence:
  ...
  44: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'COMING TO MEET means encountering.',
      Sequence:
  ...
  45: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'GATHERING TOGETHER means massing.',
      Sequence:
  ...
  46: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'That which pushes upward does not come back.',
      Sequence:
  ...
  47: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'OPPRESSION means an encounter.',
      Sequence:
  ...
  48: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE WELL means union.',
      Sequence:
  ...
  49: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'REVOLUTION means removal of that which is antiquated.',
      Sequence:
  ...
  50: {
    Scripture: {
      Hexagram: 'THE CALDRON. Supreme good fortune.\nSuccess.',
      Lines: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE CALDRON means taking up the new.',
      Sequence:
  ...
  51: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE AROUSING means beginning, arising.',
      Sequence:
  ...
  52: {
    ...
    Exegesis: {
      Judgment:
        'KEEPING STILL means stopping.\nWhen it is time to stop, then stop.\nWhen it is time to advance, then advance.\nThus movement and rest do not miss the right time,\nAnd their course becomes bright and clear.\nKeeping his stopping still means stopping in his place. Those above and those below are in opposition and have nothing in common. Therefore it is said: “He does not feel his body. He goes into his courtyard and does not see his people. No blame.”',
      Imagery: {
        Hexagram:
      ...
      Miscellaneous: 'KEEPING STILL means stopping.',
      Sequence:
  ...
  54: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE MARRYING MAIDEN shows the end of maidenhood.',
      Sequence:
  ...
  55: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'ABUNDANCE means many occasions.',
      Sequence:
  ...
  56: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'He who has few friends: this is THE WANDERER.',
      Sequence:
  ...
  57: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE GENTLE means crouching.',
      Sequence:
  ...
  58: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'THE JOYOUS is manifest.',
      Sequence:
  ...
  59: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'DISPERSION means scattering.',
      Sequence:
  ...
  60: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'LIMITATION means stopping.',
      Sequence:
  ...
  61: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'INNER TRUTH means dependability.',
      Sequence:
  ...
  62: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'PREPONDERANCE OF THE SMALL signifies a transition.',
      Sequence:
  ...
  63: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'AFTER COMPLETION means making firm.',
      Sequence:
  ...
  64: {
    ...
    Exegesis: {
      ...
      Miscellaneous: 'BEFORE COMPLETION is the exhaustion of the masculine.',
      Sequence:
...
export type HexagramTextEnglishWilhelmBaynes<
  Order extends WenWangOrder = WenWangOrder,
> = (typeof HEXAGRAM_TEXT_ENGLISH_WILHELM_BAYNES)[Order]
